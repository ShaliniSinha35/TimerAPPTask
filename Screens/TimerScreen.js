...
export default function TimerScreen({ navigation }) {
  ...
  style={styles.container}>
      <View style={styles.content}>
        ...
        <TextInput allowFontScaling={false} placeholder="Duration (seconds)" value={duration} onChangeText={setDuration} keyboardType="numeric" style={styles.input} placeholderTextColor="#ddd" />
